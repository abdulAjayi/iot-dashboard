...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <Toast connected={gatewayConnection} />
      <Header />
      <main className="p-4 flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <MetricCard
            ...
            value={data?.downhole_pressure}
            unit="psi"
          />
          <MetricCard
            label="Downhole Temp"
            value={data?.downhole_temp}
            unit="C"
          />
          <MetricCard
            label="Tubing Head Pressure"
            value={data?.tubing_head_pressure}
            unit="psi"
          />
          <MetricCard
            label="Casing Pressure"
            value={data?.casing_pressure}
            unit="psi"
          />
        </div>
        {/* Metric cards row 2 */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <MetricCard
            ...
            value={data?.flow_line_pressure}
            unit="psi"
          />
          <MetricCard
            label="Flow Line Temp"
            value={data?.flow_line_temp}
            unit="C"
          />
          <MetricCard
            label="Battery Level"
